    ...
    try {
      ...
      const msg = {
        ...
        html: `
          ...
          <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: 14px; margin: 0;">Mobile: 613.218.0587<br/>Email: contact@mariamqureshi.com (or reply to this email)</p>
        `,
      };
      sgMail.send(msg);
      ...
      const msgToMQ = {
        ...
        html: '<strong>' + req.body.name + ' just 2tried to reach you!</strong>',
      };
